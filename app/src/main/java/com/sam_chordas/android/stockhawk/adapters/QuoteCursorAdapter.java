...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
    ...
    public QuoteCursorAdapter(Context context, Cursor cursor, TextView tvNoStocks) {
        super(context, cursor);
        mContext = context;
        this.emptyView = tvNoStocks;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
        ...
        String contentDesc = String.format(mContext.getString(R.string.content_desc_quote), symbol, bid);
        viewHolder.root.setContentDescription(contentDesc);
